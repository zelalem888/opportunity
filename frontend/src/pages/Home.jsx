...
const SkeletonCard = () => (
  <div className="bg-surface-container-lowest dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700 h-[300px] flex flex-col justify-between animate-pulse">
    <div>
      <div className="flex justify-between items-start mb-4">
        <div className="w-10 h-10 rounded-xl bg-slate-200 dark:bg-slate-700"></div>
        <div className="w-16 h-5 rounded-md bg-slate-200 dark:bg-slate-700"></div>
      </div>
      <div className="w-full h-6 bg-slate-200 dark:bg-slate-700 rounded-md mb-2"></div>
      <div className="w-3/4 h-6 bg-slate-200 dark:bg-slate-700 rounded-md mb-4"></div>
      <div className="w-1/2 h-4 bg-slate-200 dark:bg-slate-700 rounded-md mb-4"></div>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-slate-900 transition-colors">
      <NavBar />
      <main className="pt-32 lg:pt-24 pb-16 px-6 max-w-7xl mx-auto">
